...
public sealed partial class AudioTab : Control
{
    ...
    public AudioTab()
    {
        ...
        Control.AddOptionCheckBox(FloofCCVars.ChelpSoundEnabled, ChelpSoundCheckBox); // Floofstation - Chelp mute button
    ...
    private void UpdateAdminButtonsVisibility()
    {
        ...
        ChelpSoundCheckBox.Visible = _admin.IsActive(); // Floofstation - Chelp mute button
    }
